...
USER_FILE = "/home/hadoop/datasource/user.list"
BRAND_FILE = "/home/hadoop/datasource/brand.list"
RECORD_FILE = "/home/hadoop/datasource/record.list"
...
def get_one_record(fake, user_list, brand_list, id):
    ...
    return record_id + "," + user_id + "," + brand_id + "," + str(transaction_time) + "," + str(
        price) + "," + source_province + "," + target_province + "," + website + "," + str(
        express_id) + "," + express + "," + ip + "," + language
